...
global units
units = ['Light', 'Humidity', 'Voltage', 'Temperature'] 
...
#estou sorteando 1 cara

    self.unit1 = np.random.randint(len(units))
    self.rate1 = np.random.randint(len(rates))    

#estou sorteando 2 cara

    self.unit2 = np.random.randint(len(units))
    self.rate2 = np.random.randint(len(rates))    
