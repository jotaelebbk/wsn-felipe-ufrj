...
class HCAMAW(RoutingProtocol):
  ...
  def setup_phase(self, network, round_nb=None):
    ...
    logging.info('HCAMAW: ordinary nodes choose nearest nearest cluster head')
