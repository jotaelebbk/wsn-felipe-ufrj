...
class SLEACH(RoutingProtocol):
  ...
  def setup_phase(self, network, round_nb=None):
    ...
    logging.info('SLEACH: ordinary nodes choose nearest nearest cluster head')
  ...
  #def awareness_phase(self, network, round_nb=None):#nova phase 

    logging.info('SLEACH: awareness phase')#novo (importar de app.py)
