...
class CAMAW(RoutingProtocol):
  ...
  def setup_phase(self, network, round_nb=None):
    ...
    logging.info('CAMAW: ordinary nodes choose nearest nearest cluster head')
