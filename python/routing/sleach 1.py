...
class SLEACH(RoutingProtocol):
  ...
  def setup_phase(self, networx222k, round_nb=None):
    ...
    Reference:
      ...
      System Sciences ls(HICSS), Hawaii, USA, January 2000.
    """
    logging.info('SLEACH: Setup phase - Configuration procedure.')#novo (Importar atributos de node.py)
